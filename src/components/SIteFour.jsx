...
import Atir3 from '../assets/atir3.png'
import Atir4 from '../assets/atir4.png'
import Atir5 from '../assets/atir5.png'
...
const SiteOne = () => {
  ...
  <div className="relative group">
    <img
      className="w-20 h-24 rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105"
      src={Img9}
      alt="100ml"
    />
